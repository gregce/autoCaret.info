...
and  <a href="https://cran.rstudio.com/web/packages/caretEnsemble/index.html" target="_top">caretEnsemble</a> `R` packages in an effort to provide a simple programmatic interface for analysts who would like to begin working on <a href="https://en.wikipedia.org/wiki/Binary_classificationl" target="_top">binary classification problems</a> . 
...
- It's pretty clear that  <a href=" http://observer.com/2016/11/machine-learning-is-revolutionizing-every-industry/" target="_top">Machine learning is revolutionizing every industry</a> - analysts and others have a real need to understand what is going on "behind the curtain"
